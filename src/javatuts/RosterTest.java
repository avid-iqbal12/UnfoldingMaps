...
/* Suppose that the members of your social networking 
 * application are stored in a List<Person> instance.
 * This section begins with a naive approach to this use case. 
 * It improves upon this approach with local and anonymous classes, 
